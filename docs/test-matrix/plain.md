...
| `plain/01_ascii.txt` | `json_mode_is_block_schema_v1` | `--mode json` 输出 `pith-json-v1` documents/blocks | JSON v1 契约 | passed | extractor-native anchors |
...
- JSON mode 当前是 Markdown-derived blocks，后续补 extractor-native anchors。
